...
async function seedPointsPackages() {
  const packages = [
    { name: '新手包', points: 500, priceCents: 500, displayOrder: 10 },
    { name: '进阶包', points: 2500, priceCents: 2500, displayOrder: 20 },
    { name: '商家包', points: 10500, priceCents: 10000, displayOrder: 30 },
  ]
